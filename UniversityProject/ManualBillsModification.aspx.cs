...
{
    public partial class ManualBillsModification : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Response.Write("<script>alert('EMPID :"+Empid+" MONTH:"+Month+" YEAR :"+year+"');</script>");
                if (ds1.Tables[0].Rows.Count!=0)
                {
                    ...
                    {
                        string deptname = SelectDeptName(Convert.ToInt16(ds1.Tables[0].Rows[0]["DEPTNO"]));
                        Response.Write("<script>alert(' Deptname=" + deptname + "');</script>");
                ...
                {
                    Response.Write("<script>alert('No Employee exists with this EMPLOYEE ID!!');</script>");
                }
            }
        }
        ...
        public DataSet SelectEmpArrearData(Int16? Empid, string Month, Int16 Year)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from MANUAL_BILLS$ where EMPNO=@EMPNO and MONTH=@MONTH and YEAR=@YEAR", con);
        ...
        {
            Response.Redirect("ManualBillsSearch.aspx");
        }
        ...
        protected void btnTotEarning_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert(' Basic:" + txtBasic.Text + " DA:"+txtDa.Text+" Hra:"+txtHra.Text+" cla:"+txtCla.Text+" Con_all:"+txtConveyAllowance.Text+" Exam_all :"+txtExamAllowance.Text+"');</script>");
            }
        }
