...
{
    public partial class WebFormFourthQuarter : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath("~/Reports/fourthquarter.rpt"));
        ...
        public void Page_PreInit(object sender, EventArgs e)
        {
            ...
            if (Session["User_Id"].ToString() != (100).ToString())
            {
                ...
                {
                    Response.Write("<script>alert('Error While Generating Fourth Quarter Report!!');</script>");
