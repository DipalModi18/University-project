<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="ManualBillsInsertion.aspx.cs" Inherits="UniversityProject.ManualBillsInsertion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="height: 20%">
        ...
        <div style="float: right; width: 50%; text-decoration: underline; height: 50%">
            <div align="center">
                <asp:Label ID="lblEmpInfo" runat="server" Text="MANUAL BILLS INFORMATION" Font-Names="Copperplate Gothic Bold" Font-Size="Large" Font-Bold="True"></asp:Label>
            </div>
        </div>
        <div style="float: right; width: 50%;">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnEmpSubmit" runat="server" Text="SUBMIT" CssClass="btnCss" OnClick="btnEmpSubmit_Click" CausesValidation="false" />
                    </td>
                </tr>
            </table>
        </div>
            ...
            <div>
                ...
                <table cellspacing="15px" style="border: medium solid #C0C0C0;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtRateOfPay" ValidationExpression="[0-9]+" ErrorMessage="Enter Alphabets and space." />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtEffectiveDays" ValidationExpression="[0-9]+" ErrorMessage="Enter Alphabets and space." />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TextBoxYear" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
                        </td>
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator46" runat="server" ErrorMessage="Enter a valid Year" ControlToValidate="TextBoxYear" ValidationExpression="^\d{4}$"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                </table>
            </div>
                            ...
                            <div style="float: right; width: 50%">
                                <table cellspacing="15px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator54" runat="server" ControlToValidate="txtOtherAllowances" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div>
                            <div style="width: 50%; float: left;">
                                ...
                                <table cellspacing="15px">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Button ID="btnGovtBal" runat="server" Text="GOVT. BAL." CssClass="btnCss" OnClick="btnGovtBal_Click" CausesValidation="false" />
                                        </td>
                                        <td>
    ...
    <div style="height:12em; width:100%"></div>
