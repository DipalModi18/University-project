...
{
    public partial class ManualBillsInsertion : System.Web.UI.Page
    {
        ...
        protected void btnEmpSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Error While Fetching Employee Record');</script>");
            }
        }
        ...
        protected void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand("select * from MANUAL_BILLS$ where EMPNO=@EMPNO and MONTH=@MONTH and YEAR=@YEAR", con);
