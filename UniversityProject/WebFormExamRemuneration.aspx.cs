...
{
    public partial class WebFormExamRemuneration : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("PopupExamRemuneration.aspx");
            }

            ReportDocument rd = new ReportDocument();
            rd.Load(Server.MapPath("~/Reports/crptExamRemuneration.rpt"));
