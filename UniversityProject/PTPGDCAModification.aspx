<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="PTPGDCAModification.aspx.cs" Inherits="UniversityProject.PTPGDCAModification" %>
...
<br />
    <div align="center">
        <br />
        <br />
       <asp:label ID="LblTitle" runat="server" text="PART TIME P.G.D.C.A COURSE MODIFCATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="X-Large" Font-Underline="True"></asp:label>
    </div>
    <br />
    <div style="height:20%">
