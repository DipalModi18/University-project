<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupSavings.aspx.cs" Inherits="UniversityProject.PopupSavings" %>
...
<body>
    ...
    <div id="dialogbox" class="dlg" style="display:block">
                            ...
                            <table class="dlgTable">
                                <tr>
                                    ...
                                    <td class="bodyTD" style="text-align:left">
                                        <asp:Label ID="lblSavingYear" runat="server" Text="Enter Saving Year :"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <%-- <td class="bodyTD">
                                    ...
                                    <td class="bodyTD">
                                        <asp:TextBox ID="txtSavingYear" runat="server" CssClass="txt"></asp:TextBox>                         
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color:red">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Enter a Valid Year" ControlToValidate="txtSavingYear" ValidationExpression="^[1-9]([0-9]{3})$"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                                <%-- <tr>
                                    <td class="bodyTD">
