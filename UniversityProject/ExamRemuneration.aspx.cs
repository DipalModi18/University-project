...
{
    public partial class ExamRemuneration : System.Web.UI.Page
    {
        ...
        public void bindYear()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Select Distinct YEAR from EXAMREMUNERATION$", con);
        ...
        protected void SEARCH_Click(object sender, EventArgs e)
        {
            ...
            if ((txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && (ddlSearchMonth.SelectedIndex <= 0) && (ddlSearchYear.SelectedIndex <= 0))
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$" + str, con);
            ...
            else if (!(txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && (ddlSearchMonth.SelectedIndex > 0) && (ddlSearchYear.SelectedIndex > 0))
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where EMPNO=@EMPNO and MONTH=@MONTH and YEAR=@YEAR" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where EMPNO=@EMPNO and MONTH=@MONTH and YEAR=@YEAR" + str + "');</script>");
            ...
            else if (!(txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && ddlSearchMonth.SelectedIndex > 0 && ddlSearchYear.SelectedIndex <= 0)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where EMPNO=@EMPNO and MONTH=@MONTH" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where EMPNO=@EMPNO and MONTH=@MONTH" + str + "');</script>");
                    cmd.Parameters.AddWithValue("EMPNO", txtSearchEmpno.Text);
                    cmd.Parameters.AddWithValue("MONTH", ddlSearchMonth.SelectedValue);
                    SqlDataAdapter dataAdapt = new SqlDataAdapter(cmd);
                    DataTable Dt = new DataTable();
            ...
            else if (!(txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && ddlSearchMonth.SelectedIndex <= 0 && ddlSearchYear.SelectedIndex > 0)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where EMPNO=@EMPNO and YEAR=@YEAR" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where EMPNO=@EMPNO and YEAR=@YEAR" + str + "');</script>");
                    cmd.Parameters.AddWithValue("EMPNO", txtSearchEmpno.Text);
                    cmd.Parameters.AddWithValue("YEAR", ddlSearchYear.SelectedValue);
                    SqlDataAdapter dataAdapt = new SqlDataAdapter(cmd);
                    DataTable Dt = new DataTable();
            ...
            else if ((txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && ddlSearchMonth.SelectedIndex > 0 && ddlSearchYear.SelectedIndex > 0)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where MONTH=@MONTH and YEAR=@YEAR" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where MONTH=@MONTH and YEAR=@YEAR" + str + "');</script>");
                    cmd.Parameters.AddWithValue("MONTH", ddlSearchMonth.SelectedValue);
                    cmd.Parameters.AddWithValue("YEAR", ddlSearchYear.SelectedValue);
                    SqlDataAdapter dataAdapt = new SqlDataAdapter(cmd);
                    DataTable Dt = new DataTable();
            ...
            else if (!(txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && ddlSearchMonth.SelectedIndex <= 0 && ddlSearchYear.SelectedIndex <= 0)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where EMPNO=@EMPNO" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where EMPNO=@EMPNO" + str + "');</script>");
                    cmd.Parameters.AddWithValue("EMPNO", txtSearchEmpno.Text);
                    SqlDataAdapter dataAdapt = new SqlDataAdapter(cmd);
                    DataTable Dt = new DataTable();
                    dataAdapt.Fill(Dt);
            ...
            else if ((txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && ddlSearchMonth.SelectedIndex <= 0 && ddlSearchYear.SelectedIndex > 0)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where YEAR=@YEAR" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where YEAR=@YEAR" + str + "');</script>");
                    cmd.Parameters.AddWithValue("YEAR", ddlSearchYear.SelectedValue);
                    SqlDataAdapter dataAdapt = new SqlDataAdapter(cmd);
                    DataTable Dt = new DataTable();
                    dataAdapt.Fill(Dt);
            ...
            else if ((txtSearchEmpno.Text == "" || txtSearchEmpno.Text == null) && ddlSearchMonth.SelectedIndex > 0 && ddlSearchYear.SelectedIndex <= 0)
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("select * from EXAMREMUNERATION$ where MONTH=@MONTH" + str, con);
                    //Response.Write("<script>alert('select * from EXAMREMUNERATION$ where MONTH=@MONTH" + str + "');</script>");
                    cmd.Parameters.AddWithValue("MONTH", ddlSearchMonth.SelectedValue);
                    SqlDataAdapter dataAdapt = new SqlDataAdapter(cmd);
                    DataTable Dt = new DataTable();
                    dataAdapt.Fill(Dt);
        ...
        protected void ButtonDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    if (chkdel.Checked)
                    {
                        ...
                        if (Confirmation == "yes")
                        {*/
                        SqlCommand cmd = new SqlCommand("delete from EXAMREMUNERATION$ where EMPNO=@EMPNO and MONTH=@MONTH and YEAR=@YEAR", con);
            ...
            {
                Response.Write("<script>alert('An Error Occured while Deleting!!')</script>");
            }
           // load_gridview();
        }
        ...
        protected void Unnamed1_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            cmd.Parameters.AddWithValue("EMPNO", (GridView1.FooterRow.FindControl("txtEmpno") as TextBox).Text);
        ...
        {
            Response.Redirect("ExamRemunerationInsertion.aspx");
        }
    }
}