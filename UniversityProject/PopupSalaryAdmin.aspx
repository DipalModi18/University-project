<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupSalaryAdmin.aspx.cs" Inherits="UniversityProject.PopupSalaryAdmin" %>
                    ...
                    <div class="dlgcontent">
                        ...
                        <div class="dlgbody">
                            <table class="dlgTable">
                                ...
                                <tr>
                                    <td class="bodyTD" style="text-align:left">
                                        <asp:Label ID="lblFac" runat="server" Text="Enter Faculty ID :"></asp:Label>
                                    </td>
                                    <td class="bodyTD">
                                        <asp:TextBox ID="txtFac" runat="server" CssClass="txt"></asp:TextBox>                         
                                    </td>
                                </tr>
                                <tr>
                                    <td style="color:red">
