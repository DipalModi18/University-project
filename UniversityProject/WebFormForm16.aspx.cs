...
{
    public partial class WebFormForm16 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for(int i=9; i<=92; i++)
            {
                if(!(i==12 || i==13 || i==17 || i==20 || i==24 || i==25 || i==32 || i==33 || i==34 || i==35 || i==61 || i==62 || i==63 || i==70 || i==71 || i==72 || i==82 || i==83 || i==84 || i==88 || i==91))
                {
                    form16.Tables[0].Columns[i].DataType = typeof(Double);
                }
                //String c = form16.Tables[0].Columns[i].ColumnName;
                //Response.Write("<script>alert('Column  :"+i+" is " + c + "');</script>");
            }
            //form16.Tables[0].Columns[104].DataType = typeof(Double);
            ...
            else { form16.Tables[0].Rows[0]["9DEDUCTIONS_AC_GROSS"] = "NIL";
