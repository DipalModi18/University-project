...
{
    public partial class SalaryModification : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (ds.Tables[0].Rows.Count != 0)
                {
                    ...
                    txtStandardDeduction.Text = ds.Tables[0].Rows[0]["STANDARD_DEDUCTION"].ToString();
        ...
        public DataSet SelectEmpArrearData(Int16? Empid, string Month, Int16 Year)
        {
            ...
            {
                Response.Write("<script>alert('Error While Fetching Salary Data!!');</script>");
                return new DataSet();
            }
        }
        ...
        public string SelectDeptName(Int16? DeptId)
        {
            ...
            {
                Response.Write("<script>alert('Error While Fetching Department Name!!');</script>");
                return "";
            }
        }
        ...
        public string SelectFacName(Int16? FacId)
        {
            ...
            {
                Response.Write("<script>alert('Error While Fetching Faculty Name!!');</script>");
                return "";
            }
        }
