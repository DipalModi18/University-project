<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="ExamRemunerationInsertion.aspx.cs" Inherits="UniversityProject.ExamRemunerationInsertion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="text-align: center; text-decoration: underline; height: 10%">
        <asp:Label ID="LblTitle" runat="server" Text="EXAM REMUNERATION INFORMATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="Large"></asp:Label>
    </div>
    <br />
    <div style="height: 20%">
    ...
    <div style="height: 50%">
        ...
        <div style="float: right; width: 50%">
            <table cellspacing="10em">
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="LblExamRemuneration" runat="server" Text="EXAM REMUNERATION :" CssClass="lblStyle"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="TxtExamRemuneration" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TxtExamRemuneration" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TxtExamRemuneration" ErrorMessage="Enter valid number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="BtnExamRemuneration" runat="server" Text="NET EXAM REMUNERATION" CssClass="btnCss" CausesValidation="false" OnClick="BtnExamRemuneration_Click" />
                    </td>
                    <td>
                        <asp:Label ID="LblnetExamRemuneration" runat="server" Text="Label"></asp:Label>
                    </td>
    ...
    <br />
    <br />
    <div align="center" style="width: 50%; height:15px">
