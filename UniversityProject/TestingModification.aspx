<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="TestingModification.aspx.cs" Inherits="UniversityProject.TestingModification" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <br />
    <div align="center">
       <asp:label ID="LblTitle" runat="server" text="TESTING INFORMATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="X-Large" Font-Underline="True"></asp:label>
    </div>
    <br />
    <div style="height:20%">
    ...
    <div style="height:50%">
        ...
        <div style="float:right;width:50%">
            <table cellspacing="10em">
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="Lbltesting" runat="server" Text="TESTING :" CssClass="lblStyle"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="Txttesting" runat="server"></asp:TextBox>
                    </td>
                    <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="Txttesting" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
        </td>
               <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="Txttesting" ErrorMessage="Enter valid number" ValidationExpression="[0-9]+"></asp:RegularExpressionValidator>  
                </td>
                </tr>
                <tr>
                    <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Txtincometax" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
               ...
               <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Txtincometax" ErrorMessage="Enter valid number" ValidationExpression="[0-9]+"></asp:RegularExpressionValidator>  
                </td>
                </tr>
                <tr>
                    <td>
            <asp:Button ID="Btntesting" runat="server" Text="NET TESTING" CssClass="btnCss" OnClick="nettesting_Click" CausesValidation="false"/>
                    </td>
                    <td>
                        <asp:Label ID="Lblnettesting" runat="server" Text="Label"></asp:Label>
                    </td>
