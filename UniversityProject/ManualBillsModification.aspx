<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="ManualBillsModification.aspx.cs" Inherits="UniversityProject.ManualBillsModification" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="height: 20%">
        ...
        <div style="float: right; width: 50%; text-decoration: underline; height: 50%">
            <div align="center">
                <asp:Label ID="lblEmpInfo" runat="server" Text="MANUAL BILLS MODIFICATION" CssClass="HeadLabel"></asp:Label>
            </div>
        </div>
    </div>
