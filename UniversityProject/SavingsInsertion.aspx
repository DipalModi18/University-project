<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="SavingsInsertion.aspx.cs" Inherits="UniversityProject.SavingsInsertion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="float: center; text-align: center; text-decoration: underline; height: 10%;">
        <asp:Label ID="lblFacInfo" runat="server" Text="SAVINGS INFORMATION" Font-Names="Copperplate Gothic Bold" Font-Size="Large" Font-Bold="True"></asp:Label>
    </div>
    ...
    <div style="width: 100%">
        <table style="width: 100%;">
            <tr>
                ...
                <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator24" runat="server" ControlToValidate="txtEmpNo" ValidationExpression="[0-9]+" ErrorMessage="Enter A valid Number" />
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Enter Employee ID" ControlToValidate="txtEmpNo"></asp:RequiredFieldValidator>
                </td>
                <td>
                    <asp:Label ID="lblSavingsYear" runat="server" Text="YEAR OF SAVINGS :" CssClass="lblStyle"></asp:Label>
                </td>
                <td>
                    <asp:DropDownList ID="ddlSavingsYear" runat="server"></asp:DropDownList>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Select a Saving Year" ControlToValidate="ddlSavingsYear"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
    </div>
        ...
        <div style="float: left; width: 50%">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="txtConToPension" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    <td>
                        <!--Donation to CMRF, PMDRF or Any such U/s 80-G. changes to Donation to MSU or U/s 80-G-->
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="txtBlindOrPh" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblPPF" runat="server" Text="Public Provident Fund" CssClass="lblStyle"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtPPF" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtPPF" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtRepayHouseLoan" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator10" runat="server" ControlToValidate="txtInterestHouseLoan" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator11" runat="server" ControlToValidate="txtAccureudInterestNSC" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator31" runat="server" ControlToValidate="txtNPS" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="float: right; width: 50%">
            <table style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server" ControlToValidate="txtNSS" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator13" runat="server" ControlToValidate="txtMutualFund" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" ControlToValidate="txtEquityLinked" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" ControlToValidate="txtTutionFees" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator16" runat="server" ControlToValidate="txtNSC" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator17" runat="server" ControlToValidate="txtLicPremium" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator18" runat="server" ControlToValidate="txtJeevanSuraksha" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator19" runat="server" ControlToValidate="txtPostalInvestment" ErrorMessage="Enter a valid Number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+" ValidationGroup="INSERT" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"></td>
