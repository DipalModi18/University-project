<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="PartTimeDegreeCourseModification.aspx.cs" Inherits="UniversityProject.PartTimeDegreeCourseModification" %>
...
<br />
    <div align="center">
        <br />
        <br />
       <asp:label ID="LblTitle" runat="server" text="PART TIME DEGREE COURSE MODIFICATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="X-Large" Font-Underline="True"></asp:label>
    </div>
    <br />
    <div style="height:20%">
        ...
        <div style="float:right;width:50%">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Txtincometax" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
               ...
               <td>
                ...
                <tr>
                    <td>
            <asp:Button ID="btnNetPTD" runat="server" Text="NET PTD" CssClass="btnCss" OnClick="btnNetPTD_Click"/>
                    </td>
                    <td>
