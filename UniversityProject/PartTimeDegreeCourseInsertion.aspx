<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="PartTimeDegreeCourseInsertion.aspx.cs" Inherits="UniversityProject.PartTimeDegreeCourseInsertion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="text-align: center; text-decoration: underline; height: 10%">
        <asp:Label ID="LblTitle" runat="server" Text="PART TIME DEGREE COURSE INFORMATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="Large"></asp:Label>
    </div>
    <br />
    <div style="height: 20%">
    ...
    <div style="height: 50%">
        ...
        <div style="float: right; width: 50%">
            <table cellspacing="10em">
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="LblPTD" runat="server" Text="PTD :" CssClass="lblStyle"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="TxtPTD" runat="server"></asp:TextBox>
                    </td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TxtPTD" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
                    </td>
                    <td>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TxtPTD" ErrorMessage="Enter valid number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="BtnDAArears" runat="server" Text="NET PTD" CssClass="btnCss" CausesValidation="false" OnClick="BtnDAArears_Click" />
                    </td>
                    <td>
                        <asp:Label ID="LblnetPTD" runat="server" Text="Label"></asp:Label>
                    </td>
