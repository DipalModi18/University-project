<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="SalaryInformation.aspx.cs" Inherits="UniversityProject.SalaryInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="height: 20%">
        ...
        <div style="float: right; width: 50%; text-decoration: underline; height: 50%">
            <div align="center">
                <asp:Label ID="lblEmpInfo" runat="server" Text="SALARY INFORMATION" Font-Names="Copperplate Gothic Bold" Font-Size="Large" Font-Bold="True"></asp:Label>
            </div>
        </div>
        <div style="float: right; width: 50%;">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnEmpSubmit" runat="server" Text="SUBMIT" CausesValidation="false" CssClass="btnCss" OnClick="btnEmpSubmit_Click" />
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div>
            ...
            <div>
                ...
                <table cellspacing="15px" style="border: medium solid #C0C0C0;">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator8" runat="server" ControlToValidate="txtEffectiveDays" ValidationExpression="[0-9]+" ErrorMessage="Enter A valid Number" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator54" runat="server" ControlToValidate="TextBoxYear" ValidationExpression="^\d{4}$" ErrorMessage="Enter a valid Year"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div style="float: right; width: 50%; height: 65%">
            ...
            <div align="center" style="width: auto">
                ...
                <asp:Button ID="btnEarning" runat="server" Text="EARNINGS" BackColor="#30415d" CssClass="btnCss" OnClick="btnEarning_Click" CausesValidation="false" />
                &nbsp;&nbsp;
                    <asp:Button ID="btnDeduction" runat="server" Text="DEDUCTIONS" BackColor="#30415d" CssClass="btnCss" OnClick="btnDeduction_Click1" CausesValidation="false" />
                &nbsp;&nbsp;
                    <asp:Button ID="btnAdvRec" runat="server" Text="ADV. & RECOVERY" BackColor="#30415d" CssClass="btnCss" OnClick="btnAdvRec_Click" CausesValidation="false" />
