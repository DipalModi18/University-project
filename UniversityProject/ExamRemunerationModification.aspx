<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="ExamRemunerationModification.aspx.cs" Inherits="UniversityProject.ExamRemunerationModification" %>
...
<br />
    <div align="center">
        <br />
        <br />
       <asp:label ID="LblTitle" runat="server" text="EXAM REMUNERATION MODIFICATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="X-Large" Font-Underline="True"></asp:label>
    </div>
    <br />
    <div style="height:20%">
        ...
        <div style="float:right;width:50%">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Txtincometax" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
               ...
               <td>
                ...
                <tr>
                    <td>
            <asp:Button ID="btnNetExamRemuneration" runat="server" Text="NET EXAM REMUNERATION" CssClass="btnCss" OnClick="btnNetExamRemuneration_Click"/>
                    </td>
                    <td>
