...
{
    public partial class WebFormFirstQuarter : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rd.Load(Server.MapPath("~/Reports/firstquarter.rpt"));
            dsFirstQuarter firstquarter = new dsFirstQuarter();


            DataRow row = firstquarter.Tables[0].NewRow();
            firstquarter.Tables[0].Rows.Add(row);
            firstquarter.Tables[0].Rows[0]["EMPNO"] = 1111;

            rd.SetDataSource(firstquarter);

            rd.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "First Quarter");*/
        ...
        public void Page_PreInit(object sender, EventArgs e)
        {
            ...
            if (Session["User_Id"].ToString() != (100).ToString())
            {
                ...
                {
                    Response.Write("<script>alert('Error While Generating First Quarter Report!!');</script>");
