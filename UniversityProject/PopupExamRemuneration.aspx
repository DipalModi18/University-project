<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupExamRemuneration.aspx.cs" Inherits="UniversityProject.PopupExamRemuneration" %>
                    ...
                    <div class="dlgcontent">
                        <div class="dlgheader">
                            <table class="dlgTable">
                                <tr>
                                    <td class="bodyTD">
                                        <p>Exam Remuneration Report Details</p>
                                    </td>
                                    <%-- <td style="width: 40px;">
