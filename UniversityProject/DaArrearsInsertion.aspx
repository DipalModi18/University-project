<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.Master" AutoEventWireup="true" CodeFile="DaArrearsInsertion.aspx.cs" Inherits="UniversityProject.DaArrearsInsertion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div style="text-align:center; text-decoration:underline; height:10%">
       <asp:label ID="LblTitle" runat="server" text="D.A. ARREARS INFORMATION" Font-Bold="True" Font-Names="Copperplate Gothic Bold" Font-Size="Large"></asp:label>
    </div>
    <br />
    <div style="height:20%">
    ...
    <div style="height:50%">
        ...
        <div style="float:right;width:50%">
            <table cellspacing="10em">
                <tr>
                    <td class="auto-style1">
                        <asp:Label ID="LblDAArears" runat="server" Text="D.A. ARREARS :" CssClass="lblStyle"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="TxtDAArears" runat="server"></asp:TextBox>
                    </td>
                    <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TxtDAArears" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
        </td>
               <td>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TxtDAArears" ErrorMessage="Enter valid number" ValidationExpression="[+-]?([0-9]*[.])?[0-9]+"></asp:RegularExpressionValidator>  
                </td>
                </tr>
                <tr>
                    <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Txtincometax" ErrorMessage="This field is compulsory."></asp:RequiredFieldValidator>
               ...
               <td>
                ...
                <tr>
                    <td>
            <asp:Button ID="BtnDAArears" runat="server" Text="NET D.A.ARREARS" CssClass="btnCss" OnClick="netDAArears_Click" CausesValidation="false"/>
                    </td>
                    <td>
                        <asp:Label ID="LblnetDAArears" runat="server" Text="Label"></asp:Label>
                    </td>
    ...
    <div style="width:50%; float:right">
           ...
           &nbsp;&nbsp;&nbsp;
            ...
            <asp:Button ID="Btncancel" runat="server" Text="CANCEL" CssClass="btnCss" OnClick="Btnclr_Click" CausesValidation="false"/>
        </div>
